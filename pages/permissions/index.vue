...
onMounted(async () => {
  loading.value = true
  try {
    await fetchAllPermissions() // <-- no need to assign roles.value yourself
  }
  finally {
    loading.value = false
  }
            ...
            <VMenu>
              ...
              <VList>
                ...
                <VListItem @click="copyUuid(item.permission_uuid)">
                  ...
                  <span class="ml-2">Copy UUID</span>
                </VListItem>
                <VDivider />
                ...
                >
                  ...
                  <span class="ml-2">Restore Permission</span>
                </VListItem>
                <VListItem
                  v-else
                ...
                >
                  ...
                  <span class="ml-2">Deactivate Permission</span>
                </VListItem>
                <VListItem
                  v-else
                ...
                >
                  ...
                  <span class="ml-2">Activate Permission</span>
                </VListItem>
              </vlist>
            </VMenu>
          </template>
